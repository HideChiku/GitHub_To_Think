...
if($logout == "logout"){
 ...
 $logout = null;
 header("location: http://'ユーザー情報'/mission_4-1_login.php");
}
...
//htmlの呼び出し---------------------------------------------------
$smarty->display('mission_4-1.html');
...
if($page > 1 ) {
?>
<a href="mission_4-1.php?page=<?php print($page - 1); ?>">前のページ</a>
<?php
}else{
?>
<!-- 前のページ -->
...
<?php
for($a = 1; $a <= $maxPage ; $a++){
  echo "<a href="."mission_4-1.php?page=".$a.">".$a."</a>"."&nbsp";
}
?>
...
if ($page < $maxPage ){
?>　　
<a href="mission_4-1.php?page=<?php print($page + 1); ?>">次のページ</a>
<?php
}else{
?>
<!-- 次のページ -->
